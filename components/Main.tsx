...
const style = {
   ...
   confirmButton: `bg-[#fdeaf0] hover:bg-[#fcdce9] my-2 rounded-2xl py-6 px-8 text-xl text-[#b0356e] font-semibold flex items-center justify-center cursor-pointer`,
 }
